...
## LSTM Model
The <b>LSTM model</b> developed and used in the web-app to generate the captions can be found in this repo : https://github.com/ajaykumar703/Image-Captioning-based-on-ML
